...
# API URLs
ADD_URL = "https://friendapi-gilt.vercel.app/add_friend?uid={uid}&password={password}&player_id={player_id}&server_name={region}"
REMOVE_URL = "https://friendapi-gilt.vercel.app/remove_friend?uid={uid}&password={password}&player_id={player_id}&server_name={region}"
